...
class testquimarchesansmock {
    ...
    void EtantDonneeLeStreamDoperationsSuivant_QuandJeLuiPasseLeBatchDeCalcule_JobientLaListeDeResultatSuivant() {
        ...
        ModeleDeCalcul modeleDeCalculSansSolutionAddition = new ModeleDeCalcul( Operateur.ADDITION, 2, 2 );
        ModeleDeCalcul modeleDeCalculSansSolutionSoustraction = new ModeleDeCalcul( Operateur.SOUSTRACTION, 5, 4 );
        ModeleDeCalcul modeleDeCalculSansSolutionMultiplication = new ModeleDeCalcul( Operateur.MULTIPLICATION, 6, 2 );
        ModeleDeCalcul modeleDeCalculSansSolutionDivision = new ModeleDeCalcul( Operateur.DIVISION, 10, 2 );
